...
function initMap() {
    ...
    var map = new google.maps.Map(document.getElementById('map'), {
        center: {lat: $('#longr').data('long-resto'), lng: $('#latr').data('lat-resto')},
        zoom: 20,
   ...
   /* var marker = new google.maps.Marker({
    ...
    var marker = new google.maps.Marker({
        map: map,
        anchorPoint: new google.maps.Point(0, -29),
        position: {lat: $('#longr').data('long-resto'), lng: $('#latr').data('lat-resto')},
        icon: 'frontend/img/location.png'/* just test*/
